<h2><a href="https://leetcode.com/problems/shortest-path-to-get-all-keys">864. Shortest Path to Get All Keys</a></h2><img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given an <code>m x n</code> grid <code>grid</code> where:</p>
